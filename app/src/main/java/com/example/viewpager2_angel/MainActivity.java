...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] labels = new String[]{"Dogs", "Cats", "Critters"};
    ...
    private class ViewPagerFragmentAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                case 0:
                    return new DogsFragment(); // calls fragment
                case 1:
                    return new CatsFragment(); // chats fragment
                case 2:
                    return new CrittersFragment(); // status fragment
            }
            return new CatsFragment(); //chats fragment
        }
